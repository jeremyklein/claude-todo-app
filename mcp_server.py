...
def get_user() -> User:
    """Get the default user for operations (SYNC)"""
    try:
...
# Decorator to make sync DB functions work in async context
...
# SYNC implementations (do the actual database work)
...
# Async wrappers for all sync functions
